...
export function IndicatorCard({label, value, indicator, icon, colorPallet, ...rest }: IndicatorCardProps) {
  ...
  return (
        <Card.Root>
          <Card.Body flexDir="row" alignItems="center" gap={6}>
            ...
            <Flex justify="center" align="center" backgroundColor={`${colorPallet}.100`} rounded="lg" p={4}>
